...
const messages = {
    "zh-TW": {
        ...
        feedbackReply: "回覆",
        feedbackReplyPlaceholder: "寫下你對這則留言的回覆...",
        feedbackReplySubmit: "送出回覆",
        feedbackReplyCancel: "取消",
        anonymousUser: "匿名使用者",
        allCategories: "全部類別",
        prevPage: "上一頁",
        nextPage: "下一頁",
    ...
    en: {
        ...
        feedbackReply: "Reply",
        feedbackReplyPlaceholder: "Write a reply to this post...",
        feedbackReplySubmit: "Send Reply",
        feedbackReplyCancel: "Cancel",
